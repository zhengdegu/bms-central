package com.gu.bms.redis.utils;
...
public class RedisUtil {
     ...
     */
    public RedisUtil(RedisConnectionFactory redisConnectionFactory, RedisTemplate stringRedisTemplate, HashOperations hashOperations) {
        ...
        return redisTemplate.execute(new RedisCallback<Boolean>() {
            ...
            public Boolean doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                try {
                    ...
                    // Redis 2.4
                    return connection.expire(key.getBytes(), TimeoutUtils.toSeconds(rawTimeout, TimeUnit.MILLISECONDS));
                }
            }
        });
    }
     ...
     * 订阅消费
     */
    public static interface RedisSubscribeCallback {
        /**
         * 消费数据
         *
         * @param msg 消息体
