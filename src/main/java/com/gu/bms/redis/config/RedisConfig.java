package com.gu.bms.redis.config;
...
public class RedisConfig {
    ...
    @Bean
    public RedisUtil redisUtil(RedisConnectionFactory redisConnectionFactory, RedisTemplate redisTemplate, HashOperations hashOperations) {
        return new RedisUtil(redisConnectionFactory, redisTemplate, hashOperations);
    }
