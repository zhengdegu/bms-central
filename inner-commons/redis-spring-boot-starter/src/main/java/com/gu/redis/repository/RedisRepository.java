package com.gu.redis.repository;
...
public class RedisRepository {
     ...
     */
    public RedisRepository(RedisConnectionFactory redisConnectionFactory, RedisTemplate stringRedisTemplate, HashOperations hashOperations) {
