...
import com.gu.business.user.domain.vo.MenuMetaVo;
import com.gu.business.user.domain.vo.MenuVo;
import com.gu.business.user.repository.MenuRepository;
...
public class MenuServiceImpl implements MenuService {
    ...
    public List<MenuDto> queryAll(MenuQueryCriteria criteria, Boolean isQuery) throws Exception {
        ...
        return menuMapper.toDto(menuRepository.findAll((root, criteriaQuery, criteriaBuilder) ->
                QueryHelp.getPredicate(root, criteria, criteriaBuilder), Sort.by(Sort.Direction.ASC, "menuSort")));
    }
